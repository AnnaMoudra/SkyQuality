...
$configurator->setDebugMode(array('147.231.26.31'));  // debug mode MUST NOT be enabled on production server
...
$configurator->createRobotLoader()
	...
	//->addDirectory(__DIR__ . '/../vendor/charts')
	//->addDirectory(__DIR__ . '/../vendor/twbs')
	//->addDirectory(__DIR__ . '/../vendor/highroller/highroller/src')
